...
import qs.modules.ii.sidebarRight.screenMirroring
...
Item {
    ...
    property bool showScreenMirroringDialog: false
    ...
    Connections {
        ...
        function onSidebarRightOpenChanged() {
            if (!GlobalStates.sidebarRightOpen) {
                ...
                root.showScreenMirroringDialog = false;
            }
        }
    }
    ...
    component LoaderedQuickPanelImplementation: Loader {
        ...
        Connections {
            ...
            function onOpenScreenMirroringDialog() {
                root.showScreenMirroringDialog = true;
            }
