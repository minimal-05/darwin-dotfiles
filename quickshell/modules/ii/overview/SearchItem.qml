...
RippleButton {
    ...
    RowLayout {
        ...
        Component {
            ...
            IconImage {
                // Resolving an app icon goes out to NSWorkspace and costs ~30ms
                // the first time each one is seen. Fifteen of those, synchronously
                // on the GUI thread, is half a second of frozen UI on the first
                // keystroke. Let the row draw immediately and the icon arrive.
                asynchronous: true
