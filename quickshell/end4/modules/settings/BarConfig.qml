...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                // Setting Low Power Mode needs `sudo pmset -a lowpowermode`,
                // which we will not prompt for from a bar button. The shell can
                // read the current state but not change it.
                visible: !Platform.isMacOS
                buttonIcon: "speed"
    ...
    ContentSection {
        ...
        ConfigSpinBox {
            // Holding Super to reveal workspace numbers is a Hyprland global
            // shortcut; macOS has no equivalent, so there is nothing to delay.
            visible: !Platform.isMacOS
            icon: "touch_long"
