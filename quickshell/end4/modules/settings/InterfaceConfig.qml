...
ContentPage {
    ...
    ContentSection {
        icon: "keyboard"
        // macOS: the cheatsheet lists Hyprland keybinds, which do not exist here.
    ...
    ContentSection {
        icon: "lock"
        // macOS: a third party cannot replace the macOS login window.
        visible: !Platform.isMacOS
    ...
    ContentSection {
        ...
        ContentSubsection {
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    // Layer surfaces are a Wayland concept; HyprlandData.layers
                    // is permanently empty here, so there is nothing to hint.
                    visible: !Platform.isMacOS
