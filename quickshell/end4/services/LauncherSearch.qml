...
Singleton {
    ...
    Process {
        ...
        function calculateExpression(expression) {
            // This spawned a process on every keystroke, including for queries
            // like "firefox" that could never be arithmetic. Ask only when there
            // is a digit to work with, and clear the previous answer so a stale
            // one cannot linger next to an unrelated query.
